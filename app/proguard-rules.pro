...
-keep class com.android.dcxiaolou.innervoice.mode.** { *; }

#-------------------------------------------------------------------------

#---------------------------------2.第三方包-------------------------------
# bmob (包含rx、okhttp3 okio、gson及org.apache.http.legacy.jar)
-ignorewarnings
...
# banner 的混淆代码 com.youth.banner.Banner
-keep class com.youth.banner.** {
    *;
 }

# GSYVideoPlayer 的混淆代码
