...
(function(w){
	...
	w[_namespace] = function(){
		...
		var _$editorUploadImageBtn = _$editorController.find(".Eleditor"); //modify by dcxiaolou
		...
		/*window.addEventListener("click", function() {
			alert("click");
			alert(document.getElementsByClassName("webuploader-element-invisible")[0].type);
		...
		document.getElementsByClassName("Eleditor-insertImage")[0].addEventListener("click", function(){
		    //alert("Hello World");
			//alert(document.getElementsByClassName("Eleditor-active")[0].innerText);
			var parent = document.getElementsByClassName("Eleditor-active")[0];
	...
	　　　　div.appendChild(img);
		...
		          reader.onloadend = function (e) {
					imgId = "#" + imgId;
		            $(imgId).attr("src",e.target.result);    //e.target.result就是最后的路径地址
		            };  
		       } 
		});
