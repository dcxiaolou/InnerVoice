...
public class ShowReadArticleFragment7 extends Fragment {
    ...
    private final static  String TAG = "Fragment7";
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        refreshLayout = (SmartRefreshLayout) rootView.findViewById(R.id.fragment_show_article_7_smart_refresh_layout);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    query.addWhereEqualTo("type", "823");
                    ...
                    query.findObjects(new FindListener<ReadArticle>() {
                        ...
                        public void done(List<ReadArticle> list, BmobException e) {
                            if (e == null) {
                                Log.d("TAG", "fragment7 list.size() = " + list.size());
                                if (list.size() < 5) {
                                    haveMoreData = false;
                                }
                                BmobFile file;
