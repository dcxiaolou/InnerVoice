...
public class ShowReadArticleFragment5 extends Fragment {

    private final static  String TAG = "Fragment5";
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        refreshLayout = (SmartRefreshLayout) rootView.findViewById(R.id.fragment_show_article_5_smart_refresh_layout);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    query.addWhereEqualTo("type", "2199");
