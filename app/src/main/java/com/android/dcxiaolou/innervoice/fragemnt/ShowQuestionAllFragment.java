...
public class ShowQuestionAllFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mRootView = inflater.inflate(R.layout.fragment_question_all, container, false);
        mContext = getContext();
        return mRootView;
    }
    ...
    * */
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        refreshLayout = (SmartRefreshLayout) mRootView.findViewById(R.id.question_all_smart_refresh_layout);
        recyclerView = (RecyclerView) mRootView.findViewById(R.id.question_all_rv);
