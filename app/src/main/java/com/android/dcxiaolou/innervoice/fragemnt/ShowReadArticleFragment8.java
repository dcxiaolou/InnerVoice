...
public class ShowReadArticleFragment8 extends Fragment {
    ...
    private final static  String TAG = "Fragment8";
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        refreshLayout = (SmartRefreshLayout) rootView.findViewById(R.id.fragment_show_article_8_smart_refresh_layout);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    query.addWhereEqualTo("type", "844");
