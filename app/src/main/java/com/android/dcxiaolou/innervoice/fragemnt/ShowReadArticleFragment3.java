...
public class ShowReadArticleFragment3 extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        refreshLayout = (SmartRefreshLayout) rootView.findViewById(R.id.fragment_show_article_3_smart_refresh_layout);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    query.addWhereEqualTo("type", "660");
                    ...
                    query.findObjects(new FindListener<ReadArticle>() {
                        ...
                        public void done(List<ReadArticle> list, BmobException e) {
                            Log.d("TAG", "fragment3 list.size() = " + list.size());
                            if (e == null) {
                                if (list.size() < 5) {
                                    haveMoreData = false;
                                }
        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.d("TAG", "fragment3 readArticleResults.size() = " + readArticleResults.size());
